...
latex_documents = [
  ('index', 'pompei.tex', u'pompei Documentation',
   u'Zulko', 'manual'),
]
...
man_pages = [
    ('index', 'pompei', u'PACKAGE_NAME Documentation',
     [u'Zulko'], 1)
]
...
texinfo_documents = [
  ('index', 'pompei', u'pompei Documentation',
   u'Zulko', 'pompei', 'One line description of project.',
   'Miscellaneous'),
]
